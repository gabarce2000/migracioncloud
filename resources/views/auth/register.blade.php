                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('cedula') }}" required autocomplete="cedula" autofocus>
...
<!--                         <div class="row mb-3">
                            <label for="numero_cuenta" class="col-md-4 col-form-label text-md-end">{{ __('NumeroCuenta') }}</label>
...
<!-- 
                        <div class="row mb-3">
                            <label for="tipo_cuenta" class="col-md-4 col-form-label text-md-end">{{ __('TipoCuenta') }}</label>
